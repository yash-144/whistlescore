...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      increment: (...args_1) => {
        ...
        if (!(typeof(secret_token_0) === 'bigint' && secret_token_0 >= 0n && secret_token_0 <= 4294967295n)) {
          __compactRuntime.typeError('increment',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(step_0).concat(_descriptor_0.toValue(secret_token_0)),
  ...
  _increment_0(context, partialProofData, step_0, secret_token_0) {
    __compactRuntime.assert(this._equal_0(secret_token_0, 42n),
                            'Invalid secret token');
    const revealed_step_0 = step_0;
    const tmp_0 = ((t1) => {
                    if (t1 > 4294967295n) {
                      throw new __compactRuntime.CompactError('counter.compact line 31 char 15: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 4294967295');
                    }
                    return t1;
